								...
								h =
									(v(p, [
										...
										},
										{
											key: "highlightBack",
											set: function (t) {
												this._highlightBack.style.opacity =
													t;
											},
										},
										{
											key: "shadowBack",
											set: function (t) {
												this._shadowBack.style.opacity =
													t;
											},
										},
										{
											key: "shadowFront",
											set: function (t) {
												this._shadowFront.style.opacity =
													t;
											},
										},
									]),
		...
		if (t && "MutationObserver" in t && "requestAnimationFrame" in t) {
			var n = (function () {
				...
				function A(r) {
					...
					return (
						...
						t &&
							t.dataset.layout &&
							(r.align =
								(t.dataset.layout.match(/left|right|center/) ||
									[])[0] || "left"),
						{
							appendTo: function (t, e) {
								var n =
									1 < arguments.length && e !== cn
										? e
										: "last";
								!r.root ||
					...
					R = function (t) {
						if (!t.fit) {
							if (
								!t.root ||
								!(
									t.root.getAttribute("data-layout") || ""
								).match(/fit/)
							)
								return void (t.fit = !1);
						...
						(t.fitInfo.availableWidth =
							t.root.parentNode.clientWidth),
							(t.fitInfo.currentWidth = t.root.scrollWidth);
						var n = Math.min(
							Math.max(
								4,
								(t.fitInfo.availableWidth /
									t.fitInfo.currentWidth) *
						...
						Math.abs(n - t.fitInfo.currentFontSize) <= 1 ||
							...
							(t.root.style.fontSize =
								t.fitInfo.currentFontSize + "px"));
					},
					L =
						"function" == typeof Symbol &&
				...
				function B(t, e, n, r) {
					...
					o
						? (o.value = n)
						: t.transforms.push({ name: e, value: n, unit: i }),
						lt(t, t.transforms);
				}
				function H(t) {
					...
					return (
						!(e.bottom < 0) &&
						!(e.top > window.scrollY + window.innerHeight)
					);
				}
				function $(t) {
					return t.trim();
				...
				function tt(t) {
					return t
						...
						.map(function (t, e) {
							return 0 < e
								? (n = t).charAt(0).toUpperCase() + n.slice(1)
								: t;
							var n;
						})
						.join("");
					...
					Et =
						"undefined" == typeof document
							...
							: function (t) {
									...
									return (
										(e.style.cssText =
											"position:absolute;visibility:hidden;color:" +
											t),
					...
					jt = function (t, e, n) {
						if (t.lastAppliedStyles !== n) {
							...
							t.style.transitionIn && t.style.transitionIn.length
								? ((r = t.style.transitionIn),
								  (i = t.style.transitionOut))
								: t.style.transition &&
				...
				function Xt(t, e) {
					return (
						t.length && e.push(1 < t.length ? t.concat() : t[0]), []
					);
				}
				function Zt(t) {
					var e = [];
				...
				function ne(t) {
					return /^(?:[\w]+\s?:\s?[\w.]+,\s?)+(?:[\w]+\s?:\s?[\w.]+)$/g.test(
						t
					)
						? t
								.match(/(?:(\w+)\s?:\s?([\w.]+))/g)
									...
									value: function () {
										...
										if (
											((this._viewDefinition =
												this._options.view),
											(this._willDestroy =
												this._options.willDestroy),
											(this._didDestroy =
												this._options.didDestroy),
											(this._didInit =
												this._options.didInit),
											(this._didUpdate =
												this._options.didUpdate),
				...
				function ze(r, e) {
					...
					var o = t.reduce(
						function (t, e) {
							var n;
							return (
								/(?:mon|tues|wednes|thurs|fri|satur|sun)day/.test(
									e
								) &&
									(t.day =
										C[
					...
					if (o.time) {
						...
						if (
							(a < 0 &&
								(o.time.setDate(o.time.getDate() + 7),
								(a = o.time - r)),
					...
					return /januari|februari|march|april|may|june|july|august|september|october|november|december/.test(
						...
						? (function (n, e) {
								...
								if (1 < t.length) {
									...
									var i = r
										.trim()
										.match(/wait\s[\d]+\s[a-z]+/);
									i && t.push(i[0]);
								}
								var o = t.reduce(
									function (t, e) {
										return (
											/([\d]+th|\dst|\dnd|first|last)/.test(
												e
											) &&
												(t.day = /^[\d]/.test(e)
													? parseInt(e, 10)
								...
								if (o.time) {
									...
									if (l.wait) return o;
									o.time = O(
										m(n, o.time) && l.date ? l.date : l.from
									);
									var s = o.time - n;
									s < 0 &&
										((o.time = O(l.from)),
				...
				var Ye = [],
					...
					$e = {
						...
						mi: function (t, e) {
							return Se(
								t,
								e.MILLISECOND_SINGULAR,
								e.MILLISECOND_PLURAL,
								1e3
							);
						},
					},
								...
								(r.view = (function t(e) {
									return e.map(function (e) {
										return (
											...
											e.transform &&
												(e.root.dataset.transform =
													e.transform),
											e.className &&
												(e.root.className =
													e.className),
											e.overlay &&
												(e.root.dataset.overlay =
													e.overlay),
											e.view
												? ((e.root.dataset.view =
														e.view),
												  e.style &&
														(e.root.dataset.style =
															e.style),
												  (e.repeat = null))
												: (e.layout &&
														(e.root.dataset.layout =
															e.layout),
												  e.repeat
														? ((e.root.dataset.repeat =
																!0),
														  (e.repeat = t(
																e.children
														  ).pop()))
					...
					tn = {
						...
						rotate: function () {
							for (
								var t = arguments.length, a = Array(t), e = 0;
								e < t;
								e++
							)
								a[e] = arguments[e];
						...
						transform: function () {
							for (
								var t = arguments.length, o = Array(t), e = 0;
								e < t;
								e++
							)
								o[e] = arguments[e];
						...
						keys: function () {
							for (
								var t = arguments.length, r = Array(t), e = 0;
								e < t;
								e++
							)
								r[e] = arguments[e];
				...
				var ln = {
					...
					count: {
						...
						schedule: function (i, t) {
							...
							var a = (o = we(it({}, Ke, { timezone: null }), o))
									.timezone
									? (function (t) {
											var e =
												6e4 *
